<div class="content-wrapper">
                    ...
                    <div class="search-table-data">
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{ $habit->title }}</td>
                                    <td>{{ ucfirst($habit->frequency ?? 'Daily') }}</td>
                                    <td>
                                        @if($habit->status)
                                    ...
                                    <td>
                                        <div class="update-webinar table-btns">
                                            <ul class="d-flex">
                                                <li>
                                                    <a href="javascript:void(0)" wire:click="edit({{ $habit->id }})">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" wire:click="delete({{ $habit->id }})">
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="text-center">No habits found.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="habitModal" tabindex="-1" role="dialog" aria-labelledby="habitModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="habitModalLabel">{{ $modalType }} Habit</h5>
