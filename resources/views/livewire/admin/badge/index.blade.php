<div class="content-wrapper">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title top-box-set">
                        <h4 class="card-title-heading">Badges & Trophies Management</h4>
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($badge->image)
                                            <img src="{{ asset('storage/' . $badge->image) }}" alt="{{ $badge->name }}" style="width: 50px; height: 50px; object-fit: cover;">
                                        @else
                                            No Image
                                        @endif
                                    </td>
                                    <td>{{ ucfirst($badge->type) }}</td>
                                    <td>{{ $badge->points_required }}</td>
                                    <td>
                                        <!-- <button wire:click="edit({{ $badge->id }})" class="btn btn-sm btn-soft-success btn-circle">
                                            <i class="dripicons-pencil"></i>
                                        </button>
                                        <button wire:click="delete({{ $badge->id }})" class="btn btn-sm btn-soft-danger btn-circle">
                                            <i class="dripicons-trash"></i>
                                        </button> -->
                                        <div class="update-webinar table-btns">
                                            <ul class="d-flex">
                                                <li>
                                                    <a href="javascript:void(0)" wire:click="edit({{ $badge->id }})">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" wire:click="delete({{ $badge->id }})">
    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="badgeModal" tabindex="-1" role="dialog" aria-labelledby="badgeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="badgeModalLabel">{{ $modalType }} Badge</h5>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="{{ $updateMode ? 'update' : 'store' }}">
                        ...
                        <div class="mb-3">
                            <label>Points Required <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" wire:model="points_required">
