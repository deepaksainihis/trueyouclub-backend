<div class="content-wrapper">
                        ...
                        <div class="table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        @if($room->icon)
                                            <i data-feather="{{ $room->icon }}" class="icon-sm me-2"></i>
                                        @endif
                                        {{ $room->name }}
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        @else
                                            <span class="badge bg-info" style="background-color: #f7dbd4ff !important;color: rgba(167, 1, 1, 1) !important;">Inactive</span>
                                        @endif
                                    </td>
                                    <td>
                                        <div class="update-webinar table-btns">
                                            <ul class="d-flex">
                                                <li>
                                                    <a href="javascript:void(0)" onclick="openChatModal('{{ rtrim(str_replace(chr(39), '', config('constants.front_end_url')), '/') }}/community/{{ $room->id }}?embed=true&forceAdmin=true', '{{ $room->name }}')" title="Enter Room">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" wire:click.prevent="edit({{ $room->id }})" title="Edit">
                                                ...
                                                <li>
                                                    <a href="javascript:void(0)" wire:click.prevent="delete({{ $room->id }})" title="Delete">
                                ...
                                @empty
                                <tr>
                                    <td colspan="4" class="text-center">No chat rooms found.</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="roomModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $modalType }} Chat Room</h5>
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="{{ $updateMode ? 'update' : 'store' }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" wire:model="icon" placeholder="e.g. coffee, heart, target">
